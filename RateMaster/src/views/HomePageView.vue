...
<template>
    ...
    <div class="container text-center p-3 mb-5">
        <div class="row g-4 pt-5 ">
            ...
            <div class="container border border-4 mt-5 p-0 text-start">
                <div class="row g-0">
                    <div class="col-md-6 col-lg-6 d-flex">
                        <div class="card-body p-5 p-lg-5">
                            <div>
                                ...
                                <h5 class="fw-normal pb-3">Explore our range of productsand find the perfect solution for your needs.</h5>
